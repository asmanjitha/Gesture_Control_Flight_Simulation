...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(ARPublisher), menuName = "Coach-AI Engine/Components/Core/ARPublisher")]
    public class ARPublisher : CoachComponent {

        public override string ComponentId => "com.coachai.engine.ar.components.ARPublisher";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.ar.ARFrame",
