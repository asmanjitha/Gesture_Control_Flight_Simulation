...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(PlaneIntersectionAnalytics), menuName = "Coach-AI Engine/Components/Generic/PlaneIntersectionAnalytics")]
    public class PlaneIntersectionAnalytics : CoachComponent {

        public override string ComponentId => "com.coachai.engine.analytics.ball.components.PlaneIntersectionAnalytics";
