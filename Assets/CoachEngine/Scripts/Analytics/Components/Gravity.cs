...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(Gravity), menuName = "Coach-AI Engine/Components/Core/Gravity")]
    public class Gravity : CoachComponent {

        public override string ComponentId => "com.coachai.engine.sensors.components.SensorComponent.Gravity";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.sensors.GravityData"
        };
        ...
        public override Dictionary<string, object> Parameters {
            get {
                ...
                AddUnlessDefault("gravity.com.coachai.engine.sensors.components.SamplingRate",
