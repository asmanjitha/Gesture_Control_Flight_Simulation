...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(Gyroscope), menuName = "Coach-AI Engine/Components/Core/Gyroscope")]
    public class Gyroscope : CoachComponent {

        public override string ComponentId => "com.coachai.engine.sensors.components.SensorComponent.Gyroscope";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.sensors.GyroscopeData"
        };
        ...
        public override Dictionary<string, object> Parameters {
            get {
                ...
                AddUnlessDefault("gyroscope.com.coachai.engine.sensors.components.SamplingRate",
