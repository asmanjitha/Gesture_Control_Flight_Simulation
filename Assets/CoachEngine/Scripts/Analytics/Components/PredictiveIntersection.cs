...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(PredictiveIntersection), menuName = "Coach-AI Engine/Components/Generic/PredictiveIntersection")]
    public class PredictiveIntersection : CoachComponent {

        public override string ComponentId => "com.coachai.engine.analytics.ball.components.PredictiveIntersection";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.analytics.soccer.intersection.PlaneIntersection",
            "com.coachai.engine.analytics.soccer.intersection.PointIntersection"
        };
