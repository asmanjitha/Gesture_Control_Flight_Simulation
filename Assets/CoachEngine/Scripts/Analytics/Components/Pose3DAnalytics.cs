...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(Pose3DAnalytics), menuName = "Coach-AI Engine/Components/HumanBody/Pose3DAnalytics")]
    public class Pose3DAnalytics : CoachComponent {

        public override string ComponentId => "com.coachai.engine.analytics.pose3d.components.Pose3DAnalytics";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.analytics.pose3d.Pose3dResult"
        };
