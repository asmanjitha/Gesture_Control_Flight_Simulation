...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(PoseReliabilityAnalytics), menuName = "Coach-AI Engine/Components/HumanBody/PoseReliabilityAnalytics")]
    public class PoseReliabilityAnalytics : CoachComponent {

        public override string ComponentId => "com.coachai.engine.analytics.pose.components.PoseReliabilityAnalytics";
