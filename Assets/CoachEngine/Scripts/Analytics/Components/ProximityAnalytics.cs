...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(ProximityAnalytics), menuName = "Coach-AI Engine/Components/BallSports/ProximityAnalytics")]
    public class ProximityAnalytics : CoachComponent {

        public override string ComponentId => "com.coachai.engine.analytics.ball.components.ProximityAnalytics";
