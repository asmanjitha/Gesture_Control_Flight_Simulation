...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(Accelerometer), menuName = "Coach-AI Engine/Components/Core/Accelerometer")]
    public class Accelerometer : CoachComponent {

        public override string ComponentId => "com.coachai.engine.sensors.components.SensorComponent.Accelerometer";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.sensors.AccelerometerData"
        };
        ...
        public override Dictionary<string, object> Parameters {
            get {
                ...
                AddUnlessDefault("accelerometer.com.coachai.engine.sensors.components.SamplingRate",
