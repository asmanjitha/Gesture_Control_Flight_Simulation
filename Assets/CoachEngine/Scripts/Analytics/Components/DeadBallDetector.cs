...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(DeadBallDetector), menuName = "Coach-AI Engine/Components/BallSports/DeadBallDetector")]
    public class DeadBallDetector : CoachComponent {

        public override string ComponentId => "com.coachai.engine.analytics.ball.components.DeadBallDetector";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.analytics.ball.pipeline.DeadBallEvent"
        };

        private static readonly bool AugmentedRealityMode = true;
        ...
        public override Dictionary<string, object> Parameters {
            get {
                ...
                AddUnlessDefault("com.coachai.engine.analytics.ball.parameters.AugmentedRealityMode",
                    augmentedRealityMode, AugmentedRealityMode, parameters
                );
                return parameters;
            }
        }
