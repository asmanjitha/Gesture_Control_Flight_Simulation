...
namespace CoachAiEngine.Analytics {
    ...
    [CreateAssetMenu(fileName = nameof(BallImpactAnalytics), menuName = "Coach-AI Engine/Components/BallSports/BallImpactAnalytics")]
    public class BallImpactAnalytics : CoachComponent {

        public override string ComponentId => "com.coachai.engine.analytics.ball.components.BallImpactAnalytics";
        private static readonly string[] eventIds =  {
            "com.coachai.engine.analytics.ball.BallImpact"
        };

        private static readonly float BallImpactDeltaVThreshold = 1.5f;
        private static readonly float BallImpactTemporalWindowSize = 0.2f;
        private static readonly float BallImpactMinimumTimeBetweenImpacts = 0.2f;
        ...
        [Tooltip("The change of object velocity due to the impact must exceed this threshold to trigger an impact [m/s]. Choose higher values for stronger/faster impacts and vice versa.")]
        public float ballImpactDeltaVThreshold = BallImpactDeltaVThreshold;
        [Tooltip("The larger the temporal window: The coarser the impact detection gets. The smaller the temporal window: More impacts can be detected in a shorter time. At the same time larger temporal windows increase robustness against erroneous detections. Choose the values depending on your use case. E.g. dribbling the ball in a basket ball environment might require a shorter window than a single kick of a ball towards the goal.")]
        public float ballImpactTemporalWindowSize = BallImpactTemporalWindowSize;
        [Tooltip("Minimum time for a new impact event to be accepted after the previous event.")]
        public float ballImpactMinimumTimeBetweenImpacts = BallImpactMinimumTimeBetweenImpacts;
        ...
        public override Dictionary<string, object> Parameters {
            get {
                ...
                AddUnlessDefault("BallImpactDeltaVThreshold",
                    ballImpactDeltaVThreshold, BallImpactDeltaVThreshold, parameters
                );
                AddUnlessDefault("BallImpactTemporalWindowSize",
                    ballImpactTemporalWindowSize, BallImpactTemporalWindowSize, parameters
                );
                AddUnlessDefault("BallImpactMinimumTimeBetweenImpacts",
                    ballImpactMinimumTimeBetweenImpacts, BallImpactMinimumTimeBetweenImpacts, parameters
                );
