...
namespace CoachAiEngine.Activities {
    ...
    [CreateAssetMenu(fileName = nameof(Pose3DSpec), menuName = "Coach-AI Engine/Activities/Human Body/Pose3DSpec")]
    public class Pose3DSpec : CoachActivity {

        public override string ActivityId => "com.coachai.activities.humanbody.pose3d.Pose3DSpec";
